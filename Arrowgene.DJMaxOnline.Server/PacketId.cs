...
public enum PacketId : ushort
{
    ...
    InitReq = 0x00, // sub_431710 doesnt seem opcode related
    Suspend = 0x00, //sub_430760 doesnt seem opcode related
    ...
    AuthenticateInSndrPwdAck = 0x14, // sub_432190 
    ...
    OnLogOutAck = 0x18,
    ClearChannelInfo = 0x00, //related to  OnDestroy
    OnChannelInfoInf = 0x0B,
    OnPeerCountInf = 0x0C,
    OnDisconnectPeerInf = 0x08,
    AliveAck = 0x06, // sub_4331B0 
    OnAliveReq = 0x07,
    OnPingTestInf = 0x03,
    PingTestInf = 0x04, //sub_4332B0
    ...
    ClearWaiterInfo = 0x00, // cant find maybe not a packet? related to OnDestroy
    UpdateWaiterInfo = 0x00, //sub_434E50 ? related to OnDestroy
    EraseWaiterInfo = 0x00, // sub_434F10 maybe just house keeping functions for below? related to OnDestroy
    ...
    OnAwardInfoInf = 0x78,
    OnGameInfoInf = 0x7A,
    UpdateUserAccountNickReq = 0x30, //sub_437950 0x1Cu  *this = 48
    OnUpdateUserAccountNickAck = 0x31,
    UpdateUserProfileReq = 0x32, //sub_437A40 0x12u  *this = 50
    ...
    UseEffectorSetInf = 0xC6, //sub_438990
    ...
    MountItemReq = 0xD7, //sub_4395C0 0x43u
    OnMountItemAck = 0xD8,
    GetPresentItemReq = 0xD9, // sub_4396E0 0xFu
    OnGetPresentItemAck = 0xDA,
    DeleteItemReq = 0xDB, // sub_439810 0x13u
    OnDeleteItemAck = 0xDC,
    OnExpiredMountItemInf = 0xE4,
    OnExpiredShopItemInf = 0xE5,
    OnAlertCreditInf = 0xE6,
    OnMsgNotifyInf = 0xF1,
    MsgRegisterUserReq = 0xF2, //sub_439CC0 0x24u
    OnMsgRegisterUserAck = 0xF3,
    OnMsgRegUserInf = 0xF4,
    OnMsgBlkUserInf = 0xF5,
    OnMsgGroupInf = 0xF6,
    PurchaseItemReq = 0xDD, // sub_439F10 0x23u
    ...
    ClearCourseList = 0x00, //:OnDestroy related
    VerifyCodeInf = 0xE7, // TODO for testing
}
